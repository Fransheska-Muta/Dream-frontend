      ...
      <main className="new-dream-container">
        ...
        <div className="mood-section">
          ...
          <div className="mood-options">
            ...
            <button
              className={mood === "Very Bad" ? "selected" : ""}
              onClick={() => setMood("Very Bad")}
            >
              Very Bad
            </button>
        ...
        <div className="interpretation-choice">
          ...
          <h3>
            Would you like an AI interpretation
            of your dream?
          </h3>
          ...
          <div className="interpretation-buttons">
            ...
            <button
              className={
                wantInterpretation === true
                  ? "selected"
                  : ""
              }
              onClick={() =>
                setWantInterpretation(true)
              }
            >
              Yes please
            </button>
            ...
            <button
              className={
                wantInterpretation === false
                  ? "selected"
                  : ""
              }
              onClick={() =>
                setWantInterpretation(false)
              }
            >
              No thank you
            </button>
